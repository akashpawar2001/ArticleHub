...
function NotFound() {
  return (
    <div>
      <div className="h-screen w-full bg-gray-50 dark:bg-transparent flex items-center">
        <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
          <div className="w-full lg:w-1/2 mx-8">
            ...
            <p className="text-2xl md:text-3xl font-light dark:text-gray-200 leading-normal mb-8">
